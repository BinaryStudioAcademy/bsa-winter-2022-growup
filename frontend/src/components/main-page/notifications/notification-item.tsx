...
const Notification = ({ title, type }: Props): ReactElement => {
  ...
  return (
    <div className="notification d-flex py-3 px-3 bg-light align-items-center border border-1 rounded-1 ">
      <div
        className={`notification__type  ${type} me-3 flex-shrink-0 position-relative px-1 py-1 rounded-circle`}
      >
      ...
      <span className="notification__time align-self-start mt-1 fs-7 ">
        11:00
      </span>
    </div>
  );
