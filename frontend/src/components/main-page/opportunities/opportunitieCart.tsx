...
const OpportunitieCart = ():ReactElement=>{
    return(
    <div className="opportunities__cart d-flex mt-3 px-3 py-3 flex-wrap rounded-1 shadow-lg border border-1 bg-gu-white justify-content-between">
        ...
        <div className="align-self-end d-flex fs-7 flex-shrink-0">
