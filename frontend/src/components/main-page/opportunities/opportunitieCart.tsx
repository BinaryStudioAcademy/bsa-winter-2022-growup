...
const OpportunitieCart = ({ isOpportunitiesPage }: Props): ReactElement => {
  return (
    <div
      className={`opportunities__cart d-flex ${
        isOpportunitiesPage
          ? 'flex-column flex-grow-1'
          : 'mt-3 px-3 py-3 flex-wrap rounded-1 shadow-lg border border-1 bg-gu-white justify-content-between'
      }`}
    >
      <div className="opportunities__cart--text d-flex flex-column flex-shrink-1 flex-grow-1 fs-7 me-3 oveflow-hidden">
        ...
        <span className="opportunities__cart--text-item mb-1 overflow-hidden">
          <span className="opportunities__type">Program:</span> QA
        </span>
        <span className="opportunities__cart--text-item mb-1 overflow-hidden">
          <span className="opportunities__type">Org:</span> Group QA team
        </span>
        <span className="opportunities__cart--text-item mb-1 overflow-hidden">
          <span className="opportunities__type">Start:</span> February 02 2022
        </span>
      </div>
      <div
      ...
      >
        <span className="me-2 opportunities__cart--tags-item text-gu-white bg-gu-purple d-flex justify-content-center flex-column rounded-1 text-center px-1">
          #Tag 1
        </span>
        <span className="me-2 opportunities__cart--tags-item text-gu-white bg-gu-purple d-flex justify-content-center flex-column rounded-1 text-center px-1">
          #Tag 2
