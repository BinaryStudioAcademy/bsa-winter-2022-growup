...
export class fixRoles1645101056527 implements MigrationInterface {
    name = 'fixRoles1645101056527';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('ALTER TYPE "public"."user_role_role_enum" RENAME TO "user_role_role_enum_old"');
        await queryRunner.query('CREATE TYPE "public"."user_role_role_enum" AS ENUM(\'Admin\', \'User\', \'Mentor\', \'Menteee\')');
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('CREATE TYPE "public"."user_role_role_enum_old" AS ENUM(\'Admin\', \'User\')');
        await queryRunner.query('ALTER TABLE "user_role" ALTER COLUMN "role" DROP DEFAULT');
