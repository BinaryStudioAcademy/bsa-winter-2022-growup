...
export class DeleteUserCascade1648118223625 implements MigrationInterface {
    name = 'DeleteUserCascade1648118223625';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('ALTER TABLE "user" ADD CONSTRAINT "FK_312670d07e7e764737ef1973e66" FOREIGN KEY ("mentorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION');
