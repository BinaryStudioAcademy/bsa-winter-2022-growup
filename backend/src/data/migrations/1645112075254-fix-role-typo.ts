...
export class fixRoleTypo1645112075254 implements MigrationInterface {
    name = 'fixRoleTypo1645112075254'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_role_role_enum_old" AS ENUM('Admin', 'Mentor', 'Menteee')`);
